	...
	*/
	...
	> {
		...
		return {
			...
			followSymlinks: stateValues.followSymlinks ?? false,
			showSymlinks: stateValues.showSymlinks ?? false,
			symlinkEnvDepth: stateValues.symlinkEnvDepth ?? 1,
			...
			systemPromptSections: stateValues.systemPromptSections,
		}
	}
